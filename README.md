...
Whether or not to use FoldX and Rosetta InterfaceAnalyzer, the files below will be generated by default.
...
*If you use Rosetta InterfaceAnalyzer or FoldX to evaluate the binding energy and n_relax>1, the below files will be generated additionally.
1. ```{pdb_id}_{chain_id}_{CDR_type}_{sample#}_best_{Foldx or IA}.pdb```: The best binding energy structure through the relaxation.
